...
const CheckoutCom = () => {
  ...
  return (
    <div className="checkout-container bg-slate-50 relative z-20 font-poppins px-5 py-6 sm:py-10  lg:px-16">
      ...
      <div className="w-full flex  md:flex-row flex-col-reverse">
        <div className=" w-full md:w-2/3 mt-8 pr-6 border border-red-500 ">
          <div className="absolute bg-gradient-to-r from-[#cdc7a2] to-[#e9e6b0] w-[10rem] md:w-[28rem] h-[5rem] md:h-[14rem] top-[20%] right-[1%] rounded-3xl -z-10 blur-[120px]"></div>
          <div className="absolute bg-gradient-to-r from-[#cff3ed] to-[#c5eee4] w-[10rem] md:w-[28rem] h-[5rem] md:h-[14rem] top-[20%] left-[1%] rounded-3xl -z-10 blur-[120px]"></div>
            ...
            <ul className="flex p-0 flex-col divide-y divide-gray-700">
              <li className="flex flex-col py-6 sm:flex-row sm:justify-between">
                <div className="flex w-full space-x-2 sm:space-x-4">
                  <Image
                    className="flex-shrink-0 object-cover w-20 h-20 border-transparent rounded outline-none sm:w-20 sm:h-20 bg-gray-500"
                    src={myImg}
                    alt="Polaroid camera"
                  />
